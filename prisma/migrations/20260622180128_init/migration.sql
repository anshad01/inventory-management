...
-- CreateEnum
CREATE TYPE "ReferenceType" AS ENUM ('PURCHASE_ORDER', 'SALE', 'MANUAL');
...
-- CreateEnum
CREATE TYPE "ShareScope" AS ENUM ('FULL_INVENTORY', 'LOW_STOCK', 'CATEGORY');
...
CREATE TABLE "ShareLink" (
    ...
    "token" TEXT NOT NULL,
    "title" TEXT NOT NULL,
    "scope" "ShareScope" NOT NULL DEFAULT 'FULL_INVENTORY',
    "categoryId" TEXT,
